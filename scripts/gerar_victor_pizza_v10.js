...
const OUTPUT = 'C:/Users/guima/Downloads/Fluxo_victor_pizza_v10.json';

const CNPJA_KEY = '1239882e-5005-475f-9be1-41b4123846dd-b7c95f5e-5c9e-4b78-9ef3-4ffdb872a793';

const d = JSON.parse(fs.readFileSync(INPUT, 'utf8'));
d.name = 'Fluxo Victor Pizza v10 - CNPJa sem verificacao WA';
...
console.log('✓ preparar_busca configurado');
...
// patch_busca_concluida usa $('enriquecer_leads').first().json._meta_bruta
// que agora vem de processar_leads
var fixCount = 0;
...
// ── 8. edit_fields: garante campo email ───────────────────────────────────────
...
console.log('\n=== VERIFICACAO FINAL ===');
var checks = [
  ['Nome v10',                  json.includes('Victor Pizza v10')],
