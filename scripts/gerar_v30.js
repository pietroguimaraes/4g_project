...
const maxResults = quantidade; // sem multiplicador — teste diagnóstico
...
// ---- 6. SALVAR v29 ----
d.name = 'Fluxo_4g — Dashboard v2 (v30 sem-multiplicador)';
const output = JSON.stringify(d, null, 2);
fs.writeFileSync('C:/Users/guima/Downloads/Fluxo_4g_v30_sem_multiplicador.json', output);
console.log('✓ Fluxo_4g_v30_sem_multiplicador.json salvo em Downloads');
