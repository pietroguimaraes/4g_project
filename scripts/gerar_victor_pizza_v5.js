...
const OUTPUT = 'C:/Users/guima/Downloads/Fluxo_victor_pizza_v5.json';

const d = JSON.parse(fs.readFileSync(INPUT, 'utf8'));
d.name = 'Fluxo Victor Pizza v5 - CNPJa substitui Apify + OpenAI';
...
console.log('Nome v5:        ' + (json.includes('Victor Pizza v5') ? 'OK' : 'FALHOU'));
